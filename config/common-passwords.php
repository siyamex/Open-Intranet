...
// Top ~100 most common passwords (lowercased) — rejected by the password policy.
return [
    ...
    'password1', 'password123', 'welcome', 'welcome1', 'admin', 'admin123', 'root', 'toor', 'passw0rd', 'p@ssw0rd',
];
